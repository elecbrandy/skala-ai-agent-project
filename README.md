...
| Retrieval   | ChromaDB MMR + BM25 Hybrid Ensemble (Hit Rate@5: 0.93, MRR: 0.67) |
...
> BM25는 수식·표 등이 많은 기술 PDF에서 낮은 성능을 보임. Dense MMR 단독 대비 Hybrid의 MRR이 소폭 낮아 해당 코퍼스에서는 Dense MMR이 어휘 매칭보다 의미 검색이 더 효과적임을 시사.
